        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastCalibrated = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResearcherProfile", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ResearcherProfile_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReactionStep", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReactionStep_Experiment_ExperimentId",
                        column: x => x.ExperimentId,
                        principalTable: "Experiment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReactionStep_ReactionStep_ParentStepId",
                        column: x => x.ParentStepId,
                        principalTable: "ReactionStep",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Experiment_ResearcherId",
                table: "Experiment",
                column: "ResearcherId");

            migrationBuilder.CreateIndex(
                name: "IX_ReactionStep_ExperimentId",
                table: "ReactionStep",
                column: "ExperimentId");

            migrationBuilder.CreateIndex(
                name: "IX_ReactionStep_ParentStepId",
                table: "ReactionStep",
                column: "ParentStepId");

            migrationBuilder.CreateIndex(
                name: "IX_ResearcherProfile_UserId",
